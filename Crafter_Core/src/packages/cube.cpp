...
CRAFTER_PACKAGE_CONSTRUCTOR_WRAPPERS_CPP(Crafter::Packages::Cube, Cube)

void Crafter::Packages::Cube::setup() {
...
void Crafter::Packages::Cube::drawEvent() {
...
void Crafter::Packages::Cube::viewportEvent(ViewportEvent &event) {
...
void Crafter::Packages::Cube::mouseReleaseEvent(MouseEvent& event) {
