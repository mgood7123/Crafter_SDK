...
CRAFTER_PACKAGE_CONSTRUCTOR_WRAPPERS_CPP(Crafter::Demo::Packages::CubeWithCamera, CubeWithCamera)

void Crafter::Demo::Packages::CubeWithCamera::setup() {
...
void Crafter::Demo::Packages::CubeWithCamera::drawEvent() {
...
void Crafter::Demo::Packages::CubeWithCamera::viewportEvent(ViewportEvent &event) {
...
void Crafter::Demo::Packages::CubeWithCamera::mousePressEvent(MouseEvent& event) {
    if(event.button() != MouseEvent::Button::Left) return;
    event.setAccepted();
}

void Crafter::Demo::Packages::CubeWithCamera::mouseReleaseEvent(MouseEvent& event) {
...
void Crafter::Demo::Packages::CubeWithCamera::mouseMoveEvent(MouseMoveEvent& event) {
